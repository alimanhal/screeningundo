...
participation in **Screening Undo** a harassment-free experience for
...
- **No gatekeeping.** First-time contributors are welcome. Stupid
...
- Tribal abuse based on which football team someone supports — we
  joke, but we don't bully
...
repository, issues, pull requests, discussions, any chat channel
linked from the repo, and when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
may be reported to the maintainers via the contact details in the
repository's *About* sidebar. All complaints will be reviewed and
