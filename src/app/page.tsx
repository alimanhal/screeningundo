...
export default async function HomePage() {
  ...
  return (
    <main className="flex flex-1 flex-col">
      <section className="border-b border-line bg-paper-raised px-4 py-8">
        <div className="mx-auto w-full max-w-6xl">
          <h1 className="display max-w-3xl text-3xl leading-tight text-ink sm:text-4xl">
            Where to watch the <span className="text-pitch-deep">2026</span>{" "}
            World Cup <span className="text-pitch-deep">near you</span>
          </h1>
